...
import { columnasMovFinanciero } from "../../utils/ColumnsTable/columnasMovFinanciero";

interface MovimientoFinancieroState {
...
const MovimientoFinanciero = () => {
	...
	return (
		<div className={style.container}>
			<h1 style={{ fontFamily: "Poppins", fontSize: "17.8px" }}>Movimientos Financieros</h1>
